...
export default class Container extends Component {
  ...
  handleClick = () => {
    ...
    const cheby = new Tone.Chebyshev(chebySettings).toDestination()
    ...
    const pingPongDelaySettings = { wet: 1, delayTime: 0.25, maxDelayTime: 1 }
    ...
    synth.chain(cheby, chorus, pingPongDelay, jcReverb, channel)
